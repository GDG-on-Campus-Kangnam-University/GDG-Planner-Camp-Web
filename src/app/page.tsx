...
import {
  ...
  AcademicCapIcon,
  UserGroupIcon,
  CheckCircleIcon, // BadgeCheckIcon 대체
  PencilIcon,
...
const HomePage = () => {
  ...
  return (
    <div className="relative flex h-screen w-full items-center justify-center bg-slate-100">
      <div
        ref={containerRef}
        className="no-scrollbar relative z-10 flex h-full w-full max-w-[600px] flex-col items-center justify-start gap-8 overflow-y-scroll rounded bg-white p-8 shadow-lg"
      >
        ...
        <div className="relative z-20 mt-20 flex flex-col items-center gap-10">
          ...
          <div className="flex flex-col items-center gap-2">
            <h1 className="text-3xl font-bold">11/30 IT 기획캠프</h1>
            <h1 className="mt-2 text-3xl font-bold">{timeLeft}</h1>
          </div>
          <div className="relative z-20 mt-10 flex w-[280px] flex-col gap-3">
        ...
        <div
          ...
          className="animate-float z-20 -translate-x-1/2 transform cursor-pointer"
