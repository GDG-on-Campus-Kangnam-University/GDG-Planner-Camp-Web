...
const UserStatisticsPage = () => {
  ...
  return <section className="flex flex-col">
    ...
    <nav className="flex flex-col gap-2 px-4 py-6">
      ...
      <h2 className="font-[700] text-2xl">팀 매출액</h2>
      <h1 className="font-[700] text-5xl h-[80px] flex justify-center items-center">{formatNumber(myTeam?.revenue as number)}</h1>
    </nav>
